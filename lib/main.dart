...
class MyApp extends StatelessWidget {
  ...
  String email="false";
  static FTPConnect ftpConnect = FTPConnect('uvkick.com',user:'u634181118.root', pass:'YstallRootPassword04@2022');
  String pass="false";
  ...
  Future<dynamic> mainScreen() async {
    ...
    if(email != null && pass != null){
       ret = SellerHome.routeName;
       print(email+"-----");
    }
    else{
      ret = SplashScreen.routeName;
      print("emial is null"+"-----");
    }
    return ret;
  }
