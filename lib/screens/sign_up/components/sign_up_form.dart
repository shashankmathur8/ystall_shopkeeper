...
class _SignUpFormState extends State<SignUpForm> {
          ...
          DefaultButton(
            ...
            press: () {
              if (_formKey.currentState!.validate()) {
                ...
                Future<bool> validated = createUser(this.name,this.email,this.password);
  ...
  Future<bool> createUser(String name,String email,String pass) async {
    await api.createContact(name,email,pass);
    return true;
  }
}
